function Employee() {
    ...
    this.role_ids = ko.observableArray([]);
    ...
    this.team_selection = ko.observable();
    this.team_name = ko.observable();
    this.gravatar_address = ko.observable("");
    this.organisation_teams = ko.observableArray([]);
...
Employee.prototype.addEmployee = function (user) {
    ...
    this.team_selection(user.team_id);
...
Employee.prototype.saveEmployee = function () {
    var self = this;
    self.team_id(self.team_selection());
    self.saving(true);
    $.post(
        "user/user",
        {data: ko.toJSON(self)},
