...
(function($, window) {
    ...
    Tour = (function() {
        ...
        Tour.prototype.getStep = function(i) {
            if (this._options.steps[i] != null) {
                return $.extend({
                    ...
                    title: "",
                    content: "<p></p>",
                    next: i === this._options.steps.length - 1 ? -1 : i *1 +1,
                    prev: i - 1,
                    animation: true,
        ...
        Tour.prototype.pause = function() {
            ...
            this._debug("Paused/Stopped step " + (this._current *1 +1) + " timer (" + this._duration + " remaining).");
        ...
        Tour.prototype.resume = function() {
            ...
            this._debug("Started step " + (this._current *1 +1) + " timer with duration " + this._duration);
        ...
        Tour.prototype.showStep = function(i) {
            ...
            showStepHelper = function(e) {
                ...
                if (_this._isOrphan(step)) {
                    if (!step.orphan) {
                        _this._debug("Skip the orphan step " + (_this._current *1 +1) + ". Orphan option is false and the element doesn't exist or is hidden.");
                        if (skipToPrevious) {
                            _this._showPrevStep();
                        } else {
                            _this._showNextStep();
                    ...
                    _this._debug("Show the orphan step " + (_this._current *1 +1) + ". Orphans option is true.");
                }
                if (step.backdrop) {
                ...
                _this._scrollIntoView(step.element, function() {
                    ...
                    return _this._debug("Step " + (_this._current *1 +1) + " of " + _this._options.steps.length);
                });
                if (step.duration) {
                    return _this.resume();
                }
